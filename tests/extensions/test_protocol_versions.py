...
class TestProtocolVersionConstants:
    ...
    def test_tenant_provider_version_exists(self):
        ...
        from luminescent_cluster.extensions.protocols import TENANT_PROVIDER_VERSION

        assert TENANT_PROVIDER_VERSION is not None

    def test_usage_tracker_version_exists(self):
        """UsageTracker has a version constant."""
        from luminescent_cluster.extensions.protocols import USAGE_TRACKER_VERSION
    ...
    def test_chatbot_auth_provider_version_exists(self):
        ...
        from luminescent_cluster.extensions.protocols import CHATBOT_AUTH_PROVIDER_VERSION
    ...
    def test_chatbot_rate_limiter_version_exists(self):
        ...
        from luminescent_cluster.extensions.protocols import CHATBOT_RATE_LIMITER_VERSION
    ...
    def test_chatbot_access_controller_version_exists(self):
        ...
        from luminescent_cluster.extensions.protocols import CHATBOT_ACCESS_CONTROLLER_VERSION
